...
PATHWAYS = [
    ...
    },
    {
        ...
        "routes": ["Degree Apprenticeship", "University"],
        "subjects": ["Computer Science", "Maths"],
        "skills": ["Problem Solving", "Logical Thinking", "Cybersecurity"],
        "description": (
    ...
    },
    {
        ...
        "routes": ["University", "Degree Apprenticeship"],
        "subjects": ["Maths", "Computer Science", "Economics"],
        "skills": ["Mathematics", "Programming", "Data Analysis"],
        "description": (
            "Use data, statistics and programming to identify patterns "
            "and solve problems."
        ),
        "skills_to_develop": [
            "Python",
    ...
    },
    {
        ...
        "skills": ["Mathematics", "Data Analysis", "Communication"],
        "description": (
            "Analyse financial information and markets to support "
    ...
    },
    {
        ...
        "routes": ["University", "Degree Apprenticeship"],
        "subjects": ["Maths", "Economics", "Computer Science"],
        "skills": ["Problem Solving", "Communication", "Data Analysis"],
        "description": (
            "Analyse business problems and help organisations improve "
