...
# ==============================================
GOOGLE_FORM_LINK = " https://docs.google.com/spreadsheets/d/1XFLfhDqtm8whNvZsAppokGzLf0AAPrgv7fy_y0ENrJQ/edit?gid=0#gid=0 "
# ==============================================
...
if st.button("🚀 Find My Perfect Career!", type="primary"):
    if not name:
        ...
        if GOOGLE_FORM_LINK != " https://docs.google.com/spreadsheets/d/1XFLfhDqtm8whNvZsAppokGzLf0AAPrgv7fy_y0ENrJQ/edit?gid=0#gid=0"
 ":
